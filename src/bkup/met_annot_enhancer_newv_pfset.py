...
job_id = '20af7fd860214351b8691f5d5811de99'

gnps_job_path = '/Users/pma/Dropbox/Research_UNIGE/git_repos/pf_project/data'
project_name = 'PF_lotus_annot'
metadata_path = '/Users/pma/210523_lotus_dnp_metadata.csv'

organism_header = 'species_cof'
...
if Run_line_x_line == True:
    dt_isdb_results = pd.merge(
       ...
       dt_isdb_results['query_otol_domain'] = domain_bio
...
print('getting cluster chem class')
...
print('chem consistency reweighing')
